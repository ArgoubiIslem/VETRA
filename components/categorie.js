...
import EditCategorie from '/pages/[id]/EditCategorie'
...
function categorie() {
  ...
  const [updateCategorie, setUpdateCategorie] = useState(false)
  ...
  return (
    <div className="container mx-auto px-4 py-16 pt-4 ">
      ...
      {updateCategorie ? (
        <EditCategorie categorie={categorieId} />
      ) : (
        <div className="mt-10">
                              ...
                              <td className="py-3 px-6 text-center">
                                <div className="item-center flex justify-center">
                                  ...
                                  <button
                                    onClick={() =>
                                      !updateCategorie
                                        ? setUpdateCategorie(true) ||
                                          setCategorieId(categorie)
                                        : setUpdateCategorie(false)
                                    }
                                  >
                                    <div className="mr-2 w-4 transform hover:scale-110 hover:text-purple-500">
                                      <svg
...
categorie.getInitialProps = async ({ query: { id } }) => {
