...
function Promos() {
  ...
  const deletePromo = async () => {
    ...
    try {
      const deleted = await fetch(`http://localhost:3000/api/Promos/${id}`, {
        method: 'Delete',
      })
  ...
  return (
    <div className="container mx-auto px-4 py-16 pt-4 ">
      <h3 className="mb-8 text-3xl font-medium text-gray-700">Promos</h3>
      <div
            ...
            <table className="w-full rounded shadow-lg">
              <thead>
                <tr className="bg-gray-200 text-sm uppercase leading-normal text-gray-600">
                  <th className="py-3 px-6 text-left">ID Produit</th>
                  <th className="py-3 px-6 text-left">Date début</th>
